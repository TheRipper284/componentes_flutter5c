...
class AppTheme{
  ...
  static const primaryColor = Color.fromARGB(195, 185, 17, 17); //195, 114, 37, 37
  static const accentColor = Color.fromARGB(237, 31, 131, 0);  //255, 209, 147, 14
  static const backColor = Color.fromARGB(255, 255, 255, 255);
  static const iconColor = Color.fromARGB(255, 209, 147, 14);
